...
set_CC="ccache clang -Os -ffunction-sections -fdata-sections --target=aarch64-unknown-linux-gnu -march=armv8.2-a+lse+crypto+dotprod -mcpu=cortex-a77 -flto -Wno-error"
