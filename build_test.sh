...
set_CC="ccache clang -Os -ffunction-sections -fdata-sections --target=aarch64-unknown-linux-musl -march=armv8.2-a+lse+crypto+dotprod -mcpu=cortex-a77 -flto=thin -Wno-error --sysroot=$TOOLCHAIN_PATH/../sysroot -I$TOOLCHAIN_PATH/../sysroot/usr/include/aarch64-linux-android"
