...
make LD="ld.lld --gc-sections --undefined=jiffies_64 --undefined=main_extable_sort_needed" CC="ccache clang -Os -ffunction-sections -fdata-sections" CXX="ccache clang++ -Os -ffunction-sections -fdata-sections" CFLAGS="$CFLAGS" CXXFLAGS="$CFLAGS" $MAKE_ARGS ${TARGET_DEVICE}_defconfig
